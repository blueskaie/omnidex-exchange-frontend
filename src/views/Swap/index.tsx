...
import { Heading, Flex, Button, Text, ArrowDownIcon, Box, useModal } from 'pancakeswap-uikit'
...
import leftimage from '../../images/tradeicon.png'
          ...
          <Flex flexDirection="row">
            <Flex flex="1"  flexDirection="column" justifyContent="center" minWidth="320px" mb="50px" mr={['8px', 0]}>
              ...
              <Heading scale="md" color="text">
                {t('Token trading at lightning speed')}
              </Heading>
            </Flex>      
            <Flex
              maxWidth= '100px'
