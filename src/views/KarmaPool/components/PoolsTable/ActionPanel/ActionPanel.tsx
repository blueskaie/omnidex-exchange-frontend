...
import { getAddress, getDojoAddress } from 'utils/addressHelpers'
  ...
  const blocksRow =
    blocksRemaining || blocksUntilStart ? (
      <Flex mb="8px" justifyContent="space-between">
        ...
        <Flex>
          <Link external href={getTelosExplorerLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
    ...
    <StyledActionPanel expanded={expanded}>
      <InfoSection>
        ...
        {poolContractAddress && (
          <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
            <LinkExternal
              href={`${BASE_TELOS_EXPLORER_URL}/address/${
                isAutoVault ? dojoContractAddress : poolContractAddress
              }`}
              bold={false}
            >
              {t('View Contract')}
      ...
      <ActionContainer>
        {showSubtitle && (
          <Text mt="4px" mb="16px" color="textSubtle">
            {isAutoVault ? t('Automatic restaking') : `${t('Earn')} CHARM ${t('Stake').toLocaleLowerCase()} CHARM`}
          </Text>
        )}
