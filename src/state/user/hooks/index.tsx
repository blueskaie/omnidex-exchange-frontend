...
export function useAudioModeManager(): [boolean, () => void] {
  ...
  // useSelector<AppState, AppState['user']['audioPlay']>((state) => state.user.audioPlay)
...
export function useGasPrice(): string {
  ...
  return userGas
  // return chainId === ChainId.MAINNET.toString() ? userGas : GAS_PRICE_GWEI.mainnet
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Charm-LP', 'Omnidex LPs')
}
