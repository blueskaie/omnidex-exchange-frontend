...
export const useKarmaWithAccount = () => {          
  const { library, account } = useActiveWeb3React()
  return useMemo(() => getKarmaContract(library.getSigner(account)), [account, library])
}
...
export const useSousChefWithAccount = (id) => {
  const { library, account } = useActiveWeb3React()
...
export const useDojoContract = () => {         
  const { library } = useActiveWeb3React()
  return useMemo(() => getDojoContract(library.getSigner()), [library])
}
export const useDojoContractWithAccount = () => {   
  const { library, account } = useActiveWeb3React()
  return useMemo(() => getDojoContract(library.getSigner(account)), [account, library])
}
