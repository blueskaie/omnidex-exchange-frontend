...
export const DMMY = new Token(ChainId.MAINNET, '0x2f15F85a6c346C0a2514Af70075259e503E7137B', 18, 'Dummy', 'DMMY')
export const KARMA = new Token(ChainId.MAINNET, '0x730d2Fa7dC7642E041bcE231E85b39e9bF4a6a64', 18, 'Charm Dojo', 'KARMA')
...
const tokens = {
  ...
  dummy: {
    symbol: 'DMMY',
    address: {
      40: '0x2f15F85a6c346C0a2514Af70075259e503E7137B',
    },
    decimals: 18,
    projectLink: 'https://omnidex.finance/',
  },
  one: {
    symbol: 'WONE',
    address: {
      40: '0x0cae51e1032e8461f4806e26332c030e34de3adb',
    },
    decimals: 18,
    projectLink: 'https://omnidex.finance/',
  }
  ...
  busd: {
    symbol: 'BUSD',
    address: {
      40: '0x99c409e5f62e4bd2ac142f17cafb6810b8f0baae',
    },
    decimals: 18,
    projectLink: 'https://omnidex.finance/',
  }
