...
var IconButton = styled__default['default'](Button)(templateObject_1$18 || (templateObject_1$18 = __makeTemplateObject(["\n  padding: 0;\n  width: ", ";\n"], ["\n  padding: 0;\n  width: ", ";\n"])), function (_a) {
    var scale = _a.scale;
...
var LogoWithText$1 = React__default['default'].memo(Logo$3, function (prev, next) { return prev.isDark === next.isDark; });
...
var Icon$13 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 97 97" }, props),
        React__default['default'].createElement("circle", { cx: "48", cy: "48", r: "48", fill: "#fff" }),
        React__default['default'].createElement("g", { clipPath: "url(#clip0)" },
            React__default['default'].createElement("path", { fill: "#3F4971", d: "M33.5233 57.4937C33.5136 57.6507 33.4556 57.8009 33.3574 57.9238C33.2592 58.0467 33.1254 58.1363 32.9744 58.1804C32.8234 58.2246 32.6625 58.2211 32.5135 58.1704C32.3646 58.1198 32.2349 58.0245 32.1421 57.8974L21.1346 47.5646C21.0035 47.471 20.9023 47.3414 20.8432 47.1915C20.7842 47.0417 20.7698 46.8779 20.8018 46.72C20.8338 46.5621 20.9109 46.4169 21.0237 46.3018C21.1365 46.1868 21.2802 46.1069 21.4374 46.0718L36.8436 39.8615C37.5608 39.5746 37.9911 39.9571 37.7999 40.7115L33.5233 57.4937Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M24.4283 67.3161C23.8387 67.8474 23.249 67.6136 23.1108 66.8433L20.0933 50.0505C19.9552 49.2855 20.3058 49.0943 20.869 49.6255L31.3452 59.459C31.4789 59.5788 31.5852 59.7261 31.6568 59.8908C31.7284 60.0554 31.7636 60.2336 31.7601 60.4131C31.7566 60.5926 31.7143 60.7693 31.6363 60.931C31.5583 61.0927 31.4463 61.2357 31.308 61.3502L24.4283 67.3161Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M37.0616 36.5195C37.1807 36.6348 37.2676 36.7793 37.3136 36.9386C37.3596 37.0978 37.3632 37.2663 37.324 37.4274C37.2848 37.5885 37.2042 37.7365 37.0902 37.8568C36.9761 37.9771 36.8326 38.0655 36.6738 38.1133L21.3207 44.2811C20.6035 44.5733 20.2582 44.212 20.5026 43.4789L26.8085 26.4417C26.8356 26.2875 26.9093 26.1453 27.0198 26.0344C27.1302 25.9234 27.2721 25.849 27.4261 25.8212C27.5802 25.7934 27.7391 25.8136 27.8813 25.8789C28.0236 25.9443 28.1424 26.0517 28.2216 26.1867L37.0616 36.5195Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M20.9753 64.4685C21.1134 65.2335 20.885 65.3291 20.444 64.6757L14.5312 55.4373C14.3251 55.0821 14.2228 54.6762 14.236 54.2658C14.2491 53.8554 14.3772 53.4569 14.6056 53.1157L17.2618 49.5298C17.724 48.9029 18.2128 48.9985 18.3509 49.7901L20.9753 64.4685Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M19.1052 42.4431C18.8343 43.1763 18.4093 43.1656 18.1649 42.4431L16.1249 36.3125C16.0126 35.9115 16.0086 35.4879 16.1131 35.0848C16.2176 34.6817 16.427 34.3135 16.7199 34.0175L23.9821 27.3822C24.5558 26.851 24.8055 27.0263 24.5133 27.7594L19.1052 42.4431Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M17.1875 44.8127C17.3016 45.2305 17.3256 45.6677 17.2578 46.0954C17.19 46.5232 17.0321 46.9316 16.7944 47.2936L14.7119 50.1252C14.2444 50.7521 13.931 50.6564 14.0107 49.8543L15.0094 40.0793C15.0891 39.3036 15.3547 39.2718 15.5991 40.0155L17.1875 44.8127Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M25.3739 22.8611C25.6289 23.1639 25.3739 23.8386 24.8002 24.3592L21.533 27.3396C20.9593 27.8708 20.8689 27.7752 21.3311 27.1536L24.0618 23.4349C24.5239 22.8292 25.1136 22.5636 25.3739 22.8611Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "
z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M23.0313 70.7641C23.3288 70.5038 23.9982 70.7641 24.5188 71.3432L27.4779 74.6263C28.0091 75.2001 27.9135 75.2957 27.2919 74.8282L23.6157 72.0816C22.9782 71.6141 22.7126 71.0244 23.0313 70.7641Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M74.0792 26.5162C74.3767 26.2559 74.9239 26.6066 75.2851 27.2919L77.442 31.3559C77.8086 32.0466 77.7076 32.1156 77.2136 31.51L74.4245 28.0834C73.9358 27.4778 73.7817 26.75 74.0792 26.5162Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M72.4003 23.9185C73.0219 24.386 73.2875 24.981 72.9847 25.236C72.6819 25.491 72.0178 25.236 71.4972 24.657L68.5381 21.3739C68.0069 20.8001 68.1025 20.7045 68.7241 21.172L72.4003 23.9185Z" }),
            React__default['default'].createElement("path", { fill: "#546095", d: "M21.5704 67.9164C22.0644 68.522 22.2185 69.2286 21.921 69.5102C21.6235 69.7917 21.0763 69.4145 20.715 68.7292L18.5529 64.6439C18.1916 63.9373 18.2925 63.8842 18.7813 64.4686L21.5704 67.9164Z" })),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip0" },
                React__default['default'].createElement("rect", { width: "68", height: "68", fill: "#fff", transform: "translate(14 14)" })))));
};
...
var IconLabel = styled__default['default'].div(templateObject_1$15 || (templateObject_1$15 = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"], ["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"])), getThemeColor, function (_a) {
    var theme = _a.theme;
...
var Grid = styled__default['default'](Box)(templateObject_1$14 || (templateObject_1$14 = __makeTemplateObject(["\n  display: grid;\n  ", "\n  ", "\n"], ["\n  display: grid;\n  ", "\n  ", "\n"])), styledSystem.flexbox, styledSystem.grid);
...
var Input$1 = styled__default['default'].input(templateObject_1$13 || (templateObject_1$13 = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n  border: 1px solid ", ";\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n  border: 1px solid ", ";\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledBalanceInput = styled__default['default'](Box)(templateObject_1$12 || (templateObject_1$12 = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var StyledInput$1 = styled__default['default'](Input$1)(templateObject_2$v || (templateObject_2$v = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n  border: none;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"], ["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n  border: none;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var PromotedGradient = styled.keyframes(templateObject_1$_ || (templateObject_1$_ = __makeTemplateObject(["\n  0% {\n    background-position: 50% 0%;\n  }\n  50% {\n    background-position: 50% 100%;\n  }\n  100% {\n    background-position: 50% 0%;\n  }\n"], ["\n  0% {\n    background-position: 50% 0%;\n  }\n  50% {\n    background-position: 50% 100%;\n  }\n  100% {\n    background-position: 50% 0%;\n  }\n"])));
/**
...
var StyledWrapper = styled__default['default'].div(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"], ["\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"])), function (_a) {
...
var Placeholder = styled__default['default'].div(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"], ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"])));
var templateObject_1$Q;

var StyledBackgroundImage = styled__default['default'](Wrapper$3)(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  background-repeat: no-repeat;\n  background-size: contain;\n"], ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"])));
...
var StyledImage = styled__default['default'].img(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"], ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"])));
...
var TokenImage = styled__default['default'](Image)(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"], ["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"])));
...
var _a$3, _b$2;
var StyledPrimaryImage = styled__default['default'](TokenImage)(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  position: absolute;\n  width: ", "; // 92, 82 are arbitrary numbers to fit the variant\n\n  ", "\n"], ["\n  position: absolute;\n  width: ", "; // 92, 82 are arbitrary numbers to fit the variant\n\n  ", "\n"])), function (_a) {
...
var StyledProfileAvatar = styled__default['default'](BackgroundImage)(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  border-radius: 50%;\n"], ["\n  border-radius: 50%;\n"])));
var StyledBunnyPlaceholder = styled__default['default'](Icon$1V)(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var GridLayout$1 = styled__default['default'](Grid)(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"], ["\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var StyledLink$1 = styled__default['default'](Text)(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var MessageContainer = styled__default['default'].div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: flex;\n  background-color: gray;\n  padding: 16px;\n  border-radius: 16px;\n  border: solid 1px;\n\n  ", "\n  ", "\n"], ["\n  display: flex;\n  background-color: gray;\n  padding: 16px;\n  border-radius: 16px;\n  border: solid 1px;\n\n  ", "\n  ", "\n"])), styledSystem.space, styledSystem.variant({
    variants: variants$3,
}));
...
var NotificationDotRoot = styled__default['default'].span(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  display: inline-flex;\n  position: relative;\n"], ["\n  display: inline-flex;\n  position: relative;\n"])));
...
var Bar = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 100%;\n  transition: width 200ms ease;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  height: 100%;\n  transition: width 200ms ease;\n"])), function (props) { return (props.primary ? props.theme.colors.secondary : props.theme.colors.secondary + "80"); });
Bar.defaultProps = {
    primary: false,
};
...
var ProgressBunnyWrapper = styled__default['default'].div(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"], ["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"])));
...
var SliderLabelContainer = styled__default['default'].div(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 30px);\n"], ["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 30px);\n"])));
...
var waves = styled.keyframes(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n   from {\n        left: -150px;\n    }\n    to   {\n        left: 100%;\n    }\n"], ["\n   from {\n        left: -150px;\n    }\n    to   {\n        left: 100%;\n    }\n"])));
...
var Icon$1 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "-64 -64 238 256" }, props),
        React__default['default'].createElement("g", { transform: "rotate(0 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.9166666666666666s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(30 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.8333333333333334s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(60 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.75s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(90 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.6666666666666666s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(120 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.5833333333333334s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(150 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.5s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(180 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.4166666666666667s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(210 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.3333333333333333s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(240 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.25s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(270 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.16666666666666666s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(300 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "-0.08333333333333333s", repeatCount: "indefinite" }))),
        React__default['default'].createElement("g", { transform: "rotate(330 50 50)" },
            React__default['default'].createElement("rect", { x: "47", y: "24", rx: "3", ry: "6", width: "6", height: "12", fill: "#1fc7d4" },
                React__default['default'].createElement("animate", { attributeName: "opacity", values: "1;0", keyTimes: "0;1", dur: "1s", begin: "0s", repeatCount: "indefinite" })))));
};
...
var rotate = styled.keyframes(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
styled__default['default'](Icon)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var StepperWrapper = styled__default['default'].div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"], ["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"])));
...
var StyledStep = styled__default['default'](Flex)(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  ", " {\n    justify-content: center;\n  }\n"], ["\n  ", " {\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var SubMenuContainer = styled__default['default'].div(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var ClickableElementContainer = styled__default['default'].div(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  cursor: pointer;\n"], ["\n  cursor: pointer;\n"])));
...
var Td = styled__default['default'].td(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n\n  ", "\n"], ["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
}, function (_a) {
    var theme = _a.theme;
...
var Table = styled__default['default'].table(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  max-width: 100%;\n  width: 100%;\n\n  tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"], ["\n  max-width: 100%;\n  width: 100%;\n\n  tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"])), Td, styledSystem.space);
var templateObject_1$s;
...
var Wrapper$1 = styled__default['default'](Flex)(templateObject_1$r || (templateObject_1$r = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var Tab = styled__default['default'].button(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"])), getPadding, getBorderRadius, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, styledSystem.color);
Tab.defaultProps = {
...
var Arrow = styled__default['default'].div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  &,\n  &::before {\n    position: absolute;\n    width: 10px;\n    height: 10px;\n    border-radius: 2px;\n    z-index: -1;\n  }\n\n  &::before {\n    content: \"\";\n    transform: rotate(45deg);\n    background: ", ";\n  }\n"], ["\n  &,\n  &::before {\n    position: absolute;\n    width: 10px;\n    height: 10px;\n    border-radius: 2px;\n    z-index: -1;\n  }\n\n  &::before {\n    content: \"\";\n    transform: rotate(45deg);\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ModalHeader = styled__default['default'].div(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"], ["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"])), function (_a) {
...
var ModalTitle = styled__default['default'](Flex)(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  align-items: center;\n  flex: 1;\n"], ["\n  align-items: center;\n  flex: 1;\n"])));
...
var Spacer = function (_a) {
    ...
    var spacing = React.useContext(styled.ThemeContext).spacing;
    var s;
    switch (size) {
        case 'lg':
            s = spacing[6];
    ...
    return React__default['default'].createElement(StyledSpacer, { size: s });
};
var StyledSpacer = styled__default['default'].div(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  height: ", "px;\n  width: ", "px;\n"], ["\n  height: ", "px;\n  width: ", "px;\n"])), function (props) { return props.size; }, function (props) { return props.size; });
var templateObject_1$l;

var ModalActions = function (_a) {
    var children = _a.children;
    var l = React__default['default'].Children.toArray(children).length;
    return (React__default['default'].createElement(StyledModalActions, null, React__default['default'].Children.map(children, function (child, i) { return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledModalAction, null, child),
        i < l - 1 && React__default['default'].createElement(Spacer, null))); })));
};
var StyledModalActions = styled__default['default'].div(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", "00;\n  display: flex;\n  margin: 0;\n  padding: ", "px 0;\n"], ["\n  align-items: center;\n  background-color: ", "00;\n  display: flex;\n  margin: 0;\n  padding: ", "px 0;\n"])), function (props) { return props.theme.colors.primaryDark; }, function (props) { return props.theme.spacing[4]; });
var StyledModalAction = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  flex: 1;\n"], ["\n  flex: 1;\n"])));
var templateObject_1$k, templateObject_2$b;

var StyledIconContainer = styled__default['default'].div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  background: ", ";\n"], ["\n  background: ", ";\n"])), function (_a) {
...
var StyledBottomNavItem = styled__default['default'].button(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 16px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"], ["\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 16px;\n  }\n  &:hover,\n  &:hover div {\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledBottomNav = styled__default['default'](Flex)(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n"], ["\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ", ";\n  border-top: 1px solid ", ";\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var DropdownMenuItem = styled__default['default'].button(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"], ["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"])), function (_a) {
...
var StyledDropdownMenuItemContainer = styled__default['default'].div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  &:first-child > ", " {\n    border-top-left-radius: 8px;\n    border-top-right-radius: 8px;\n  }\n\n  &:last-child > ", " {\n    border-bottom-left-radius: 8px;\n    border-bottom-right-radius: 8px;\n  }\n"], ["\n  &:first-child > ", " {\n    border-top-left-radius: 8px;\n    border-top-right-radius: 8px;\n  }\n\n  &:last-child > ", " {\n    border-bottom-left-radius: 8px;\n    border-bottom-right-radius: 8px;\n  }\n"])), DropdownMenuItem, DropdownMenuItem);
...
var StyledFooter = styled__default['default'](Flex)(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  background: ", ";\n"], ["\n  background: ", ";\n"])), darkColors.backgroundAlt);
styled__default['default'].ul(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  list-style: none;\n  margin-bottom: 40px;\n\n  ", " {\n    margin-bottom: 0px;\n  }\n"], ["\n  list-style: none;\n  margin-bottom: 40px;\n\n  ", " {\n    margin-bottom: 0px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://omnidex.link/swap?outputCurrency=0x7fc6A0c5Fa947e41F42dD1DB6b64E071748eA85e", target: "_blank" },
...
var Logo$2 = function (_a) {
    ...
    var textColor = isDark ? "#FFFFFF" : "#000000";
    return (React__default['default'].createElement(Svg, { viewBox: "0 0 69 37", height: "37px", width: "69px", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React__default['default'].createElement("path", { d: "M7.36027 22.4928H9.60035V20.4855H7.50573C5.76021 20.4855 5.14928 19.5254 5.14928 17.8963V9.31414H9.80399V7.36498H5.14928V2.9721H2.99647V6.60859C2.99647 7.10315 2.67646 7.36498 2.26917 7.36498H0V9.31414H2.85101V17.9254C2.85101 20.98 4.56744 22.4928 7.36027 22.4928Z", fill: textColor }),
        React__default['default'].createElement("path", { d: "M20.2701 22.871C23.8193 22.871 26.4666 20.8637 27.3103 18.0417H24.9248C24.2266 19.8163 22.3065 20.7764 20.2991 20.7764C17.1863 20.7764 15.2371 18.769 15.1208 15.7435H27.4558V14.7253C27.4558 10.3615 24.7211 6.98679 20.1246 6.98679C15.9935 6.98679 12.7061 10.0996 12.7061 14.9289C12.7061 19.4672 15.6444 22.871 20.2701 22.871ZM15.179 13.707C15.4117 10.9142 17.5936 9.08141 20.1246 9.08141C22.6847 9.08141 24.8084 10.6815 25.012 13.707H15.179Z", fill: textColor }),
        React__default['default'].createElement("path", { d: "M33.6567 22.4928H34.7622V20.4564H34.064C33.3367 20.4564 32.9585 20.02 32.9585 19.2636V0.673828H30.6602V19.2636C30.6602 21.3291 31.7657 22.4928 33.6567 22.4928Z", fill: textColor }),
        React__default['default'].createElement("path", { d: "M62.2559 22.871C65.776 22.871 68.1325 20.9509 68.1325 18.0999C68.1325 11.8451 59.0558 15.0453 59.0558 11.2051C59.0558 9.89598 60.2777 8.96504 62.1686 8.96504C64.176 8.96504 65.2524 9.92507 65.456 11.3506H67.667C67.4343 8.61594 65.1069 6.98679 62.3141 6.98679C59.1431 6.98679 56.8448 8.64503 56.8448 11.2051C56.8448 17.1981 65.8924 13.9689 65.8924 18.2163C65.8924 19.7582 64.6414 20.8637 62.3723 20.8637C60.1613 20.8637 58.8812 19.9036 58.6194 18.0999H56.3793C56.6412 20.9218 58.6776 22.871 62.2559 22.871Z", fill: textColor }),
        React__default['default'].createElement("g", { filter: "url(#filter0_i)" },
            React__default['default'].createElement("circle", { cx: "45.3794", cy: "14.8694", r: "8.02467", fill: "url(#paint0_linear)" })),
        React__default['default'].createElement("path", { d: "M39.5566 33.104C40.7806 33.104 41.5006 32.4 41.5006 31.52C41.5006 29.256 38.3966 30.32 38.3966 28.792C38.3966 28.328 38.7406 27.888 39.5326 27.888C40.2926 27.888 40.7166 28.28 40.7166 28.92H41.3806C41.3806 27.76 40.3886 27.296 39.5406 27.296C38.4126 27.296 37.7486 27.992 37.7486 28.792C37.7486 31.032 40.8446 29.808 40.8446 31.56C40.8446 32.144 40.3166 32.504 39.5806 32.504C38.7326 32.504 38.2046 31.984 38.2046 31.336H37.5566C37.5566 32.376 38.4446 33.104 39.5566 33.104ZM46.6918 33H47.5318L48.7878 28.272H48.8358L50.0918 33
terUnits: "userSpaceOnUse", colorInterpolationFilters: "sRGB" },
                ...
                React__default['default'].createElement("feOffset", { dx: "-3.95798" }),
                React__default['default'].createElement("feGaussianBlur", { stdDeviation: "1.31933" }),
                React__default['default'].createElement("feComposite", { in2: "hardAlpha", operator: "arithmetic", k2: "-1", k3: "1" }),
                React__default['default'].createElement("feColorMatrix", { type: "matrix", values: "0 0 0 0 0.682353 0 0 0 0 0.45098 0 0 0 0 0.980392 0 0 0 0.56 0" }),
                React__default['default'].createElement("feBlend", { mode: "normal", in2: "shape", result: "effect1_innerShadow" })),
            React__default['default'].createElement("linearGradient", { id: "paint0_linear", x1: "37.3547", y1: "14.8694", x2: "53.4041", y2: "14.8694", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#AE73FA" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#AE73FA", stopOpacity: "0" })),
            React__default['default'].createElement("linearGradient", { id: "paint1_linear", x1: "53.4041", y1: "14.8694", x2: "37.3547", y2: "14.8694", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#AE73FA" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#AE73FA", stopOpacity: "0" })))));
};
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://omnidex.link/swap?outputCurrency=0x7fc6A0c5Fa947e41F42dD1DB6b64E071748eA85e", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$21, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var StyledMenuItem = styled__default['default'].a(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n\n  color: ", ";\n  font-size: 16px;\n  font-weight: ", ";\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background: ", ";\n    ", ";\n  }\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n\n  color: ", ";\n  font-size: 16px;\n  font-weight: ", ";\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background: ", ";\n    ", ";\n  }\n"])), function (_a) {
...
var StyledSubMenuItems = styled__default['default'](Flex)(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  scrollbar-width: none;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"], ["\n  background-color: ", ";\n  box-shadow: inset 0px -2px 0px -8px rgba(133, 133, 133, 0.1);\n  overflow-x: scroll;\n  scrollbar-width: none;\n  -ms-overflow-style: none;\n  &::-webkit-scrollbar {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var SubMenuItems = function (_a) {
    ...
    return (React__default['default'].createElement(StyledSubMenuItems, __assign({ justifyContent: ["start", null, "center"] }, props, { pl: ["12px", null, "0px"] }), items.length !== 1 && items.map(function (_a) {
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "DemoSwap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "DemoSwap home page" }, innerLogo))));
};
...
var links = [
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://omnidex.link",
            },
            {
                label: "Liquidity",
                href: "https://omnidex.link/#/pool",
            },
        ],
    },
    {
...
var connectors = [
    ...
    },
    {
        title: "Anchor",
        icon: Icon$1d,
        connectorId: exports.ConnectorNames.Anchor,
        priority: 3,
    },
    // {
    //   title: "Trust Wallet",
...
var CreateEthAccountConfirmationModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { width: "30%!important", title: title, headerBackground: "gradients.cardHeader", onDismiss: onDismiss },
        React__default['default'].createElement(Text, { fontSize: "20px" }, "You don't have EVM address for Telos account, do you want to create one? You will not be able to send transactions without an EVM address."),
        React__default['default'].createElement(ModalActions, null,
            React__default['default'].createElement(Button, { variant: "secondary", onClick: handleRejection, width: "100%" }, "No"),
            React__default['default'].createElement(Button, { width: "100%", onClick: handleConfirmation }, "Yes"))));
};
var WalletCard = function (_a) {
    ...
    var onPresentCallback = useModal(React__default['default'].createElement(CreateEthAccountConfirmationModal, { title: "Create Eth account from Telos account", handleConfirm: handleConfirm, handleReject: handleReject, onDismiss: onDismiss, logout: logout }), true, true, 'createEthAccountModal')[0];
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            React__default['default'].createElement(WalletWrapper, { py: "24px", maxHeight: "453px", overflowY: "auto" },
                React__default['default'].createElement(Grid, { gridTemplateColumns: "1fr 1fr" }, displayListConfig.map(function (wallet) { return (React__default['default'].createElement(Box, { key: wallet.title },
                    React__default['default'].createElement(WalletCard, { walletConfig: wallet, login: login, logout: logout, handleConfirm: handleConfirm, handleReject: handleReject, onDismiss: onDismiss }))); }))))));
};
...
var useWalletModal = function (login, logout, handleConfirm, handleReject, account) {
    var onPresentConnectModal = useModal(React__default['default'].createElement(ConnectModal, { login: login, logout: logout, handleConfirm: handleConfirm, handleReject: handleReject }))[0];
...
exports.LogoWithTextIcon = LogoWithText$1;
